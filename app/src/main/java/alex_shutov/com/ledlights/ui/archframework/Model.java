...
package alex_shutov.com.ledlights.ui.archframework;
 ...
 * how the Model gets its data, but an implementation class ModelWithLoaderManager is
 * provided, obtaining the data from the ScheduleProvider by creating a CursorLoader and then
 * parsing the received Cursor. Not all features use this way of loading the data, but
 * a lot of them do.
 * <p/>
 * Additionally, when a {@link UserActionEnum} is received, the model updates both its own data and
 * the stored data, typically by making an update or insert call on the ScheduleProvider.
 * <p/>
 */
