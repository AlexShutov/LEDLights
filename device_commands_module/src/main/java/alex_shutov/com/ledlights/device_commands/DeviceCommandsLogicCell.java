...
public class DeviceCommandsLogicCell extends LogicCell {
    ...
    private DeviceControlPortAdapter controlPortAdapter;
    ...
    public DeviceControlPort getControlPort() {
        return controlPortAdapter;
    }

    public void setControlPortAdapter(DeviceControlPortAdapter controlPortAdapter) {
